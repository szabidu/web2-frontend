...
case 1:
	...
	break;
case 2:
	alert('Név regisztrálása\n\nNick kiválasztásához és arra váltáshoz, majd annak egy jelszó segítségével való regisztrálásához az alábbi sort kell beírnod a bal fenti "Status" fülön, szóköz nélkül az elején, azaz a "/"-jellel kezdve a sorodat: /msg nickserv register <jelszo> <emailcim>');
	break;
case 3:
